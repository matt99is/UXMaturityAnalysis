"""Tests for loading analysis config models."""

from src.config_loader import AnalysisConfig, AnalysisType


def test_analysis_type_has_observation_focus() -> None:
...
def test_analysis_type_observation_focus_defaults_to_empty() -> None:
